...
const ViewNHIAEnrollee = () => {

    const { getAllAndSearchNhiaEnrolleeAuth } = useEnrollee()
    ...
    useEffect(() => {
        const fetchData = async () => {
            setLoading(true)
            const response = await getAllAndSearchNhiaEnrolleeAuth(tableData)
    ...
    return (
        <>
            ...
            <div className="lg:flex items-center justify-between mb-4 flex flex-col lg:flex-row lg:items-center">
                <h3 className="mb-4 lg:mb-0">NHIA Enrollees</h3>
                ...
                <div className="flex justify-end mb-4 items-center">
                    ...
                    <div>
                        <Button
                            className="mr-2"
                            variant="solid"
                            onClick={() => navigate('/nhia/enrollee/create')}
                            icon={<HiPlus />}
                        >
                            <span>Add NHIA Enrollees</span>
                        </Button>
                    </div>
...
export default ViewNHIAEnrollee