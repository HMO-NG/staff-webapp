...
const viewProcedure = () => {
    ...
    const handleAction = async (cellProps: CellContext<Procedure, unknown>, key: any) => {
    ...
    const handleRowSelect = (checked: boolean, row: Procedure) => {
        console.log('row', row)
        if (checked) {
    ...
    const handleAllRowSelect = (checked: boolean, rows: Row<Procedure>[]) => {
