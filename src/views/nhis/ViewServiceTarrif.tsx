    ...
    return (
        <>
            ...
            <div className="lg:flex items-center justify-between mb-4 flex flex-col lg:flex-row lg:items-center">
                <h3 className="mb-4 lg:mb-0">NHIA Service Tarrif</h3>
                ...
                <div className="flex justify-end mb-4 items-center">
                    ...
                    {/* Add Nhia service tarrif btn */}
                    <div>
                        <Button
                            className="mr-2"
                            variant="solid"
                            onClick={() => navigate('/nhia/tarrif/services/create')}
                            icon={<HiPlus />}
                        >
                            <span>Add NHIA Tarrif</span>
                        </Button>
                    </div>
...
export default viewServiceTarrif